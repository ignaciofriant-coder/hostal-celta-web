...
(function () {
  ...
  var MEDIA = [
    ...
    { src: "assets/01_dormitorio_cama.jpg", type: "image", alt: { es: "Literas del dormitorio compartido", en: "Bunk beds in the shared dorm" } },
    ...
    { src: "assets/12_invitado_handpan.jpg", type: "image", alt: { es: "Handpan en la terraza, frente al bosque", en: "Handpan on the deck, facing the forest" } }
  ];

  /* ---------------- TEXTOS ---------------- */
  var ES = {
    navRooms: "Alojamiento", navExp: "Experiencias", navPucon: "Qué hacer", navLocation: "Ubicación",
    navFaq: "Bueno saber", navGal: "Galería", navRev: "Opiniones", book: "Reservar",
    heroKicker: "Hostal de madera · Ambiente íntimo · Pucón",
    heroTitle: "Al calor del fuego, en el corazón de Pucón.",
    heroText: "Llega, deja la mochila y ponte cómodo. Una casa de madera pequeña donde se cocina, se conversa y se toca música.",
    ...
    hostKicker: "Bienvenidos", hostTitle: "Un lugar pequeño, hecho para conocerse.",
    hostP1: "Soy Alex. Me gustan la montaña, el agua y recibir gente. Levanté esta casa de madera pensando en que fuera cómoda y tranquila, pero, sobre todo, en que quien llega no se sienta como un huésped más.",
    ...
    expP1: "Aquí pasa algo casi todas las semanas: música en vivo, sobremesas junto a la chimenea y encuentros como el “Café de la Muerte”. Puedes sumarte, conversar o simplemente sentarte a escuchar.",
    expP2: "Quienes pasan por acá recuerdan la comodidad, pero sobre todo recuerdan las noches.",
    ...
    houseText: "Sin lujos innecesarios: todo lo que hace falta para estar cómodo y una chimenea que reúne a todo el mundo.",
    puconKicker: "Qué hacer en Pucón", puconTitle: "El sur, a la puerta de la casa.",
    puconP1: "Pucón se camina en diez minutos, pero se descubre durante semanas: el volcán Villarrica, las termas escondidas entre el bosque, el lago, los saltos de agua y los senderos de araucarias.",
    puconP2: "Te ayudamos a organizar el día: qué rutas están abiertas, qué agencia conviene, a qué hora salir y cómo regresar. Tenemos mapas, contactos locales y bastones disponibles en la entrada.",
    actCta: "Cómo llegar →", distNote: "Distancias aproximadas desde Hostal Celta.",
    altVolcano: "El volcán Villarrica desde Pucón",
    locKicker: "Ubicación", locTitle: "Pucón, entre el lago y el volcán.",
    locText: "Callejón Flores 260, Pucón. A diez minutos caminando del centro, en una calle tranquila y con el volcán a la vista.",
    locHowTo: "El terminal de buses está a unos diez minutos a pie. Desde el Aeropuerto La Araucanía, el viaje demora aproximadamente una hora y veinte minutos en automóvil o transfer.",
    ...
    faqKicker: "Bueno saber", faqTitle: "Antes de venir",
    ctaTitle: "¿Te guardamos una cama?",
    ctaText: "Cuéntanos tus fechas y te confirmamos qué camas están disponibles.",
    ctaBooking: "Reservar en Booking", ctaAirbnb: "Reservar en Airbnb", ctaWhats: "Consultar por WhatsApp",
    ctaReassure: "Respondemos normalmente entre las 9:00 y las 23:00 (hora de Chile). La consulta no confirma la reserva hasta recibir nuestra respuesta.",
    directTitle: "Reserva directa",
    directR1: "Te respondemos con la disponibilidad y los pasos para confirmar.",
    directR2: "Trato directo con Alex: grupos, estadías largas o llegadas a última hora.",
    directR3: "Check-in de 14:00 a 23:00. Para llegadas fuera de horario, escríbenos antes.",
    directHours: "Respondemos de 9:00 a 23:00 (hora de Chile).",
    footerTagline: "Un hogar de madera con alma celta, a diez minutos caminando del centro de Pucón.",
    footerHouse: "La casa", footerPucon: "Pucón", footerContact: "Contacto",
    footerHours: "Check-in 14:00–23:00 · Check-out 10:00–11:00",
    placeholderNote: "Fase de diseño: WhatsApp, enlace de Booking, precios de las dobles, fotos en alta y dominio son marcadores pendientes.",
    formKicker: "Escríbenos", formTitle: "Cuéntanos cuándo vienes",
    formText: "Si prefieres escribir con más detalle, déjanos tus datos y te respondemos con lo que hay libre.",
    fName: "Tu nombre", fIn: "Llegada", fOut: "Salida", fGuests: "Personas", fMsg: "Mensaje",
    fMsgHint: "Cuéntanos si viajas en grupo, si llegas de noche o lo que necesites.",
    fSend: "Consultar disponibilidad", fNote: "Al enviar se abre WhatsApp con tu mensaje listo. Te respondemos con la disponibilidad y los pasos para confirmar.",
  ...
  var EN = {
    ...
    navFaq: "Good to know", navGal: "Gallery", navRev: "Reviews", book: "Book now",
    heroKicker: "Timber hostel · Intimate atmosphere · Pucón",
    heroTitle: "By the fire, in the heart of Pucón.",
    heroText: "Arrive, drop your backpack and make yourself at home. A small wooden house where people cook, talk and play music.",
    ...
    expP1: "Something happens here most weeks: live music, long talks by the fire and gatherings like “Café de la Muerte”. Join in, chat, or just sit and listen.",
    expP2: "Guests remember the comfort — but above all, they remember the nights.",
    ...
    houseText: "No unnecessary luxuries: everything you need to be comfortable, and a fireplace that pulls everyone together.",
    puconKicker: "Things to do in Pucón", puconTitle: "Patagonia's north, right outside.",
    puconP1: "Pucón takes ten minutes to walk and weeks to explore: the Villarrica volcano, hot springs hidden in the forest, the lake, waterfalls and araucaria trails.",
    puconP2: "We help you plan the day: which routes are open, which agency to pick, when to leave and how to get back. Maps, local contacts and hiking poles are there by the door.",
    actCta: "How to get there →", distNote: "Approximate distances from Hostal Celta.",
    altVolcano: "Villarrica volcano seen from Pucón",
    locKicker: "Location", locTitle: "Pucón, between lake and volcano.",
    locText: "Callejón Flores 260, Pucón. A ten-minute walk from the centre, on a quiet street with the volcano in view.",
    locHowTo: "The bus terminal is about a ten-minute walk away. From La Araucanía airport, the drive or transfer takes roughly one hour and twenty minutes.",
    ...
    faqKicker: "Good to know", faqTitle: "Before you come",
    ctaTitle: "Shall we save you a bed?",
    ctaText: "Tell us your dates and we'll confirm which beds are free.",
    ctaBooking: "Book on Booking.com", ctaAirbnb: "Book on Airbnb", ctaWhats: "Ask on WhatsApp",
    ctaReassure: "We usually reply between 9 am and 11 pm (Chile time). Your message doesn't confirm the booking until we get back to you.",
    directTitle: "Book direct",
    directR1: "We reply with availability and the steps to confirm.",
    directR2: "Straight to Alex: groups, long stays or late arrivals.",
    directR3: "Check-in 2 pm to 11 pm. Arriving outside those hours? Write to us first.",
    directHours: "We reply 9 am–11 pm (Chile time).",
    footerTagline: "A timber home with a Celtic soul, a ten-minute walk from the centre of Pucón.",
    footerHouse: "The house", footerPucon: "Pucón", footerContact: "Contact",
    footerHours: "Check-in 2–11 pm · Check-out 10–11 am",
    placeholderNote: "Design phase: WhatsApp number, Booking link, double-room rates, high-res photos and domain are still placeholders.",
    formKicker: "Write to us", formTitle: "Tell us when you're coming",
    formText: "If you'd rather write in more detail, leave your details and we'll reply with what's available.",
    fName: "Your name", fIn: "Check-in", fOut: "Check-out", fGuests: "Guests", fMsg: "Message",
    fMsgHint: "Tell us if you're travelling as a group, arriving late, or anything else you need.",
    fSend: "Check availability", fNote: "Sending opens WhatsApp with your message ready. We reply with availability and the steps to confirm.",
  ...
  var DATA = {
    es: {
      agenda: [
        { day: "Miércoles", name: "Piano y sobremesa junto a la chimenea", time: "21:00" },
        { day: "Viernes", name: "Handpan en el salón", time: "22:00" },
      ...
      rooms: [
        ...
        { num: "Opción 02", name: "Habitación Triskel", img: "assets/07_triskel.jpg", imgOrder: "order:2", imgPos: "center 72%",
          desc: "La doble más nueva de la casa, revestida en madera clara y con un guiño celta en cada detalle. Para quienes buscan privacidad sin perderse el ambiente del salón.",
        ...
        { num: "Opción 03", name: "Doble Superior", img: "assets/09_rincon_guitarra.jpg", imgOrder: "", imgPos: "center",
          desc: "Habitación doble con balcón y vistas a la ciudad y la montaña. Y siempre a un paso, el salón con chimenea y la cocina compartida donde todo sucede.",
          specs: ["1 cama doble", "Balcón", "Vistas"],
          includes: ["Ropa de cama", "Toallas", "Balcón privado", "Baño compartido", "WiFi", "Cocina"],
          price: "Tarifa por confirmar (pendiente)", promo: "" }
      ],
      amenities: [
        ...
        { name: "Jardín y terraza con tumbonas", n: "05" }, { name: "Juegos de mesa y Smart TV", n: "06" },
        { name: "Info turística y ayuda con rutas", n: "07" }, { name: "Espacios interiores libres de humo", n: "08" }
      ],
      activities: [
        { name: "Volcán Villarrica", dist: "10 km", desc: "Ascenso guiado al cráter humeante, de madrugada. Se reserva con un día de antelación." },
        { name: "Termas del bosque", dist: "15–35 km", desc: "Pozones de agua caliente entre helechos. Las mejores, al atardecer y sin apuro." },
        { name: "Lago Villarrica", dist: "900 m", desc: "Playa de arena negra para nadar, kayak o simplemente mirar el volcán." },
        { name: "Parque Nacional Huerquehue", dist: "33 km", desc: "Trekking entre araucarias y lagunas. La caminata clásica de la zona: medio día." },
        { name: "Ojos del Caburgua", dist: "16 km", desc: "Saltos de agua turquesa a un paso del camino. Ideal para media mañana." },
        { name: "Centro de Ski Pucón", dist: "16 km", desc: "Nieve sobre el volcán en invierno; en verano, mirador con vistas al lago." }
      ],
      distances: [
      ...
      faq: [
        { q: "Horarios de check-in y check-out", a: "Check-in de 14:00 a 23:00; check-out de 10:00 a 11:00. Si tu bus llega antes o después, avísanos y lo arreglamos." },
        { q: "¿Hay desayuno?", a: "No servimos desayuno, pero tienes a disposición una cocina equipada con ollas, vajilla y refrigerador." },
        { q: "¿Se puede llegar con mascota?", a: "No aceptamos mascotas, por la casa compartida y las alergias de otros huéspedes." },
        { q: "¿Se puede fumar?", a: "No se permite fumar dentro de la casa. Puedes hacerlo en el jardín o la terraza." },
        { q: "¿Fiestas?", a: "Música sí, fiestas no. Después de medianoche bajamos el volumen: hay gente que madruga para subir al volcán." },
        { q: "¿Estacionamiento?", a: "Sí, estacionamiento privado gratuito dentro de la propiedad, sin reserva previa." },
        { q: "¿Qué idiomas hablan?", a: "Español e inglés. Con un poco de paciencia, también nos entendemos en portugués." },
        { q: "¿Cómo llego?", a: "Diez minutos a pie desde el terminal de buses de Pucón. Desde el Aeropuerto La Araucanía, el viaje demora aproximadamente 1 hora y 20 minutos en automóvil o transfer compartido." }
      ]
    },
    en: {
      agenda: [
        { day: "Wednesday", name: "Piano and long talks by the fireplace", time: "9 pm" },
        { day: "Friday", name: "Handpan in the lounge", time: "10 pm" },
      ...
      rooms: [
        ...
        { num: "Option 02", name: "Triskel room", img: "assets/07_triskel.jpg", imgOrder: "order:2", imgPos: "center 72%",
          desc: "The newest double in the house, lined in pale timber with a Celtic nod in every detail. For guests who want privacy without missing the lounge.",
        ...
        { num: "Option 03", name: "Superior double", img: "assets/09_rincon_guitarra.jpg", imgOrder: "", imgPos: "center",
          desc: "A double room with a balcony looking over town and mountains. And always a step away: the fireplace lounge and the shared kitchen where everything happens.",
          specs: ["1 double bed", "Balcony", "Views"],
          includes: ["Bed linen", "Towels", "Private balcony", "Shared bathroom", "WiFi", "Kitchen"],
          price: "Rate to be confirmed (placeholder)", promo: "" }
      ],
      amenities: [
        ...
        { name: "Garden and terrace with loungers", n: "05" }, { name: "Board games and smart TV", n: "06" },
        { name: "Local tips and route planning", n: "07" }, { name: "Smoke-free indoors", n: "08" }
      ],
      activities: [
        { name: "Villarrica volcano", dist: "10 km", desc: "Guided pre-dawn climb to the smoking crater. Book a day ahead." },
        { name: "Forest hot springs", dist: "15–35 km", desc: "Thermal pools among the ferns. Best at dusk, with nowhere to rush." },
        { name: "Lake Villarrica", dist: "900 m", desc: "Black-sand beach for swimming, kayaking, or just watching the volcano." },
        { name: "Huerquehue National Park", dist: "33 km", desc: "Trekking among araucaria trees and lagoons. The classic half-day hike." },
        { name: "Ojos del Caburgua", dist: "16 km", desc: "Turquoise waterfalls right off the road. Perfect for a late morning." },
        { name: "Pucón Ski Centre", dist: "16 km", desc: "Snow on the volcano in winter; in summer, a lookout over the lake." }
      ],
      distances: [
      ...
      faq: [
        { q: "Check-in and check-out", a: "Check-in 2 pm to 11 pm; check-out 10 to 11 am. If your bus arrives outside those hours, let us know and we'll sort it out." },
        { q: "Is breakfast included?", a: "We don't serve breakfast, but you have a fully equipped kitchen at your disposal: pots, crockery and a fridge." },
        { q: "Can I bring a pet?", a: "No pets, sorry — shared house and other guests' allergies." },
        { q: "Can I smoke?", a: "Smoking isn't allowed inside the house. You can smoke in the garden or on the terrace." },
        { q: "Parties?", a: "Music yes, parties no. After midnight we turn it down: some guests get up before dawn to climb the volcano." },
        { q: "Parking?", a: "Yes — free private parking on the property, no booking needed." },
        { q: "Which languages do you speak?", a: "Spanish and English. With a little patience, Portuguese works too." },
        { q: "How do I get there?", a: "A ten-minute walk from Pucón bus terminal. From La Araucanía airport, the drive takes roughly 1 h 20 by car or shared transfer." }
      ]
    }
  };
  ...
  function view() {
    ...
    var hero =
      '<section id="inicio" data-parallax="1" aria-label="' + att(t.heroKicker) + '" style="position:relative;min-height:'+heroH+';display:flex;align-items:flex-end;background-image:url(\'assets/02_fachada_dia.jpg\');background-size:cover;background-position:center 42%">' +
        ...
        '<div style="position:relative;z-index:2;max-width:1140px;margin:0 auto;width:100%;padding:0 28px 78px">' +
          '<p style="font-size:12px;letter-spacing:.28em;text-transform:uppercase;color:#DDB55E;font-weight:700;margin:0">' + esc(t.heroKicker) + '</p>' +
          ...
          '<div style="display:flex;gap:14px;flex-wrap:wrap">' +
            '<a href="#contacto" style="background:#B65A32;color:#fff;font-size:14.5px;font-weight:600;letter-spacing:.05em;padding:15px 30px;border-radius:2px" data-hover="background:#9d4826;color:#fff">' + esc(t.heroCta) + '</a>' +
            '<a href="#alojamiento" style="border:1px solid rgba(247,241,226,.65);color:#F7F1E2;font-size:14.5px;font-weight:600;letter-spacing:.05em;padding:14px 29px;border-radius:2px" data-hover="background:rgba(247,241,226,.16);color:#F7F1E2">' + esc(t.heroCta2) + '</a>' +
          '</div>' +
        '</div>' +
      '</section>';
    ...
    var host =
      '<section data-reveal="1" style="padding:34px 0 100px">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:1.05fr .95fr;gap:66px;align-items:center">' +
          ...
          '<div style="position:relative">' +
            '<img src="assets/08_salon_cocina.jpg" alt="' + att(t.altKitchen) + '" loading="lazy" decoding="async" style="width:100%;height:570px;object-fit:cover;object-position:center 34%;border-radius:3px" />' +
    ...
    var experiences =
      '<section id="experiencias" style="background:#2E1D12;color:#F1E9D6;position:relative;overflow:hidden">' +
        ...
        '<div data-expgrid="1" style="position:relative;z-index:2;display:grid;grid-template-columns:1fr 1fr">' +
          '<div data-expimg="1" style="background-image:url(\'assets/05_salon_musica.jpg\');background-size:cover;background-position:center;min-height:640px"></div>' +
    ...
    var roomBlocks = d.rooms.map(function (room) {
      ...
      return '<div style="display:grid;grid-template-columns:1fr 1fr;gap:54px;align-items:center;margin-bottom:78px">' +
        '<div style="' + esc(room.imgOrder) + '">' +
          '<img src="' + att(room.img) + '" alt="' + att(alt) + '" loading="lazy" decoding="async" style="width:100%;height:460px;object-fit:cover;object-position:' + esc(room.imgPos) + ';border-radius:3px;transition:transform .6s ease" data-hover="transform:scale(1.02)" />' +
        '</div>' +
        '<div>' +
    ...
    var rooms =
      '<section id="alojamiento" data-reveal="1" style="padding:104px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
          '<div style="max-width:660px;margin:0 auto 64px;text-align:center">' +
    ...
    var amenityRows = d.amenities.map(function (am) {
      return '<p style="display:flex;justify-content:space-between;align-items:baseline;gap:16px;border-bottom:1px solid #E2D6BE;padding:12px 0;margin:0;font-size:15.5px;color:#3A2617">' + esc(am.name) + ' <span style="font-family:Cormorant Garamond,Georgia,serif;font-size:11.5px;color:#C2AC84;letter-spacing:.06em">' + esc(am.n) + '</span></p>';
    }).join("");
    var house =
      '<section data-reveal="1" style="background:#F8F2E4;border-top:1px solid #E2D6BE;border-bottom:1px solid #E2D6BE;padding:74px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:.85fr 1.15fr;gap:64px;align-items:start">' +
          '<div>' +
            ...
            '<p style="color:#6A5744;font-size:16.5px;margin:0;text-wrap:pretty">' + esc(t.houseText) + '</p>' +
          '</div>' +
    ...
    var actCards = d.activities.map(function (a) {
      return '<a href="' + att(mapUrl(a.name)) + '" target="_blank" rel="noopener" style="display:flex;flex-direction:column;background:#F8F2E4;border:1px solid #E2D6BE;border-radius:3px;padding:24px 24px 20px;color:inherit;transition:transform .3s ease,box-shadow .3s ease,border-color .3s ease" data-hover="transform:translateY(-3px);box-shadow:0 10px 26px rgba(46,29,18,.1);border-color:#C89A3E;color:inherit">' +
        '<div style="display:flex;justify-content:space-between;align-items:baseline;gap:12px;margin-bottom:8px">' +
          '<h3 style="font-family:Cormorant Garamond,Georgia,serif;font-weight:600;font-size:20px;color:#6B4327;margin:0">' + esc(a.name) + '</h3>' +
          '<span style="font-size:13px;color:#9A7526;font-weight:700;white-space:nowrap">' + esc(a.dist) + '</span></div>' +
        '<p style="color:#56442F;font-size:15.5px;line-height:1.55;margin:0 0 16px;text-wrap:pretty">' + esc(a.desc) + '</p>' +
        '<span style="margin-top:auto;font-size:12.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#B65A32">' + esc(t.actCta) + '</span></a>';
    }).join("");
    var pucon =
      '<section id="pucon" data-reveal="1" style="padding:104px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
          '<div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;margin-bottom:56px">' +
            ...
            '</div>' +
            '<div><img src="assets/03_pucon_volcan.jpg" alt="' + att(t.altVolcano) + '" loading="lazy" decoding="async" style="width:100%;height:420px;object-fit:cover;border-radius:3px" /></div>' +
          '</div>' +
          '<div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px">' + actCards + '</div>' +
    ...
    var location =
      '<section id="ubicacion" data-parallax="1" aria-label="' + att(t.altNight) + '" style="position:relative;min-height:'+locH+';display:flex;align-items:center;background-image:url(\'assets/04_fachada_noche.jpg\');background-size:cover;background-position:center">' +
        ...
        '<div style="position:relative;z-index:2;max-width:1140px;margin:0 auto;width:100%;padding:88px 28px;color:#F1E9D6;display:grid;grid-template-columns:.92fr 1.08fr;gap:56px;align-items:center">' +
          '<div>' +
            ...
            '<p style="color:#EFE5D2;font-size:17px;max-width:44ch;margin:0 0 26px;text-wrap:pretty">' + esc(t.locText) + '</p>' +
            '<div style="display:grid;grid-template-columns:minmax(0,1fr);gap:0;max-width:44ch">' + distRows + '</div>' +
            '<p style="font-size:14.5px;color:#EFE5D2;margin:24px 0 0;max-width:44ch">' + esc(t.locHowTo) + '</p>' +
          '</div>' +
    ...
    var tiles = MEDIA.map(function (m, idx) {
      var inner = m.type === "video"
        ? '<video src="' + att(m.src) + '" muted loop autoplay playsinline aria-label="' + att(m.alt[state.lang]) + '" style="width:100%;display:block" data-stop="1"></video>' +
        ...
        : '<img src="' + att(m.src) + '" alt="' + att(m.alt[state.lang]) + '" loading="lazy" decoding="async" style="width:100%;display:block" />';
    ...
    var gallery =
      '<section id="galeria" data-reveal="1" style="padding:104px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
    ...
    var reviews =
      '<section id="opiniones" data-reveal="1" style="background:#F8F2E4;border-top:1px solid #E2D6BE;padding:100px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
    ...
    var faqItems = d.faq.map(function (q) {
      return '<details data-faq="1"' + (isMobile() ? '' : ' open') + ' style="border-bottom:1px solid #E2D6BE;padding:18px 0">' +
        ...
        '</summary>' +
        '<p style="color:#56442F;font-size:15.5px;line-height:1.6;margin:6px 0 0;text-wrap:pretty">' + esc(q.a) + '</p></details>';
    }).join("");
    var faq =
      '<section id="faq" data-reveal="1" style="padding:52px 0 88px">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
          ...
          '</div>' +
          '<div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 56px">' + faqItems + '</div>' +
        '</div>' +
      '</section>';

    var waLbl = waLabel();
    var cta =
      '<section id="reservar" style="background:#6B4327;color:#F1E9D6;padding:92px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center">' +
          '<div>' +
            ...
            '</div>' +
            '<p style="font-size:13.5px;line-height:1.6;color:#C7AE8F;margin:18px 0 0;max-width:46ch">' + esc(t.ctaReassure) + '</p>' +
          '</div>' +
          '<div data-direct="1" style="background:#5A371F;border:1px solid rgba(247,241,226,.2);border-radius:3px;padding:30px 34px">' +
            '<p style="font-size:11.5px;letter-spacing:.24em;text-transform:uppercase;color:#DDB55E;font-weight:700;margin:0 0 18px">' + esc(t.directTitle) + '</p>' +
            '<p style="color:#EFE0C8;font-size:15.5px;line-height:1.6;margin:0;padding:0 0 14px;border-bottom:1px solid rgba(247,241,226,.16);text-wrap:pretty">' + esc(t.directR1) + '</p>' +
            '<p style="color:#EFE0C8;font-size:15.5px;line-height:1.6;margin:0;padding:14px 0;border-bottom:1px solid rgba(247,241,226,.16);text-wrap:pretty">' + esc(t.directR2) + '</p>' +
            '<p style="color:#EFE0C8;font-size:15.5px;line-height:1.6;margin:0;padding:14px 0 0;text-wrap:pretty">' + esc(t.directR3) + '</p>' +
            (waLbl ? '<p style="font-family:Cormorant Garamond,Georgia,serif;font-size:19px;color:#DDB55E;margin:18px 0 0">' + esc(waLbl) + '</p>' : '') +
          '</div>' +
        '</div>' +
      '</section>';
    ...
    var contact =
      '<section id="contacto" data-reveal="1" style="background:#F8F2E4;border-top:1px solid #E2D6BE;padding:92px 0">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:.85fr 1.15fr;gap:60px;align-items:start">' +
          '<div>' +
            ...
            '<p style="color:#6A5744;font-size:16.5px;margin:0 0 18px;text-wrap:pretty">' + esc(t.formText) + '</p>' +
            '<p style="font-size:13.5px;line-height:1.6;color:#8A7359;margin:0">' + esc(t.fNote) + '</p>' +
          '</div>' +
      ...
      '<footer style="background:#2E1D12;color:#CDBBA1;padding:70px 0 40px">' +
        '<div style="max-width:1140px;margin:0 auto;padding:0 28px">' +
          '<div style="display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:44px">' +
            '<div>' +
              '<div style="display:flex;align-items:center;gap:13px;margin-bottom:16px">' +
                '<img src="assets/logo.jpg" alt="' + att(t.altLogo) + '" style="width:48px;height:48px;border-radius:50%" />' +
            ...
            '<div>' +
              ...
              fl("https://maps.google.com/?q=Callej%C3%B3n+Flores+260,+Puc%C3%B3n,+Chile", "Callejón Flores 260", true) +
              fl("https://www.instagram.com/hostalcelta/", "@hostalcelta", true) +
              fl(CFG.whatsappUrl, "WhatsApp", true) + fl(CFG.reservaUrl, "Booking", true) + fl(CFG.airbnbUrl, "Airbnb", true) + fl("#contacto", t.formKicker) +
            '</div>' +
          '</div>' +
          '<div style="border-top:1px solid rgba(241,233,214,.14);margin-top:48px;padding-top:22px;font-size:13px;color:#9C8B76;display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px">' +
            '<span>© 2026 Hostal Celta · hostalcelta.cl (dominio pendiente)</span>' +
            '<span>' + esc(t.footerHours) + '</span>' +
          '</div>' +
          '<p style="margin:22px 0 0;font-size:12px;color:#7E6E5C;font-style:italic">' + esc(t.placeholderNote) + '</p>' +
        '</div>' +
      '</footer>';
    ...
    return header + hero + trust + host + experiences + rooms + house + pucon + location + gallery + reviews + faq + cta + contact + footer + sticky;
  }
  ...
  function renderLightbox() {
    ...
    var media = m.type === "video"
      ? '<video src="' + att(m.src) + '" controls autoplay loop playsinline style="width:100%;max-height:78vh;object-fit:contain;border-radius:3px;margin:0 auto"></video>'
      : '<img src="' + att(m.src) + '" alt="' + att(m.alt[state.lang]) + '" style="width:auto;max-width:100%;max-height:78vh;object-fit:contain;border-radius:3px;margin:0 auto" />';
    root.innerHTML =
