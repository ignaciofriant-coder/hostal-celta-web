  ...
  var DATA = {
    es: {
      ...
      rooms: [
        ...
        { num: "Opción 02", name: "Triskel · Doble Superior", img: "assets/19_doble_mural_volcan.jpg", imgOrder: "order:2", imgPos: "center 45%",
          desc: "Nuestra habitación doble, con nombre celta: cama doble frente a un mural pintado a mano del volcán Villarrica, con araucarias y un pajarito en la rama. Luz de mañana y vista al jardín. Para quienes buscan privacidad sin perderse el ambiente del salón.",
    ...
    en: {
      ...
      rooms: [
        ...
        { num: "Option 02", name: "Triskel · Superior double", img: "assets/19_doble_mural_volcan.jpg", imgOrder: "order:2", imgPos: "center 45%",
          desc: "Our double room, with a Celtic name: a double bed facing a hand-painted mural of Villarrica volcano, with monkey-puzzle trees and a little bird on the branch. Morning light and a garden view. For guests who want privacy without missing the lounge.",
